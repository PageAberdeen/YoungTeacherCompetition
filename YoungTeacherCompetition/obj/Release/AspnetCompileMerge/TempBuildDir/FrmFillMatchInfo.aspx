...
<%@ Page Title="" Language="C#" MasterPageFile="~/index.Master" AutoEventWireup="true" CodeBehind="FrmFillMatchInfo.aspx.cs" Inherits="ComputerBS.FrmFillMatchInfo"  %>
    ...
    <div class="content">
        <div class="modal" runat="server" id="showMyInfo" style="display:none">
            <div class="moadl-dialog" >
                <ul>
                    <li>该申报账号所属城区/区县为:<span class="msg-box js-county"><%=myDistrictName%></span></li>
                    <li>该申报账号所属学校为:<span class="msg-box js-school"><%=mySchoolName%></span></li>
       ...
       <p><span class="regForm-item-tit">学科:</span> <asp:DropDownList runat="server" ID="DropList_Subject" AutoPostBack="false" class="select-box mb20"></asp:DropDownList></p>
        ...
        <asp:GridView ID="GridViewData" CssClass="content" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" OnPageIndexChanging="GridViewData_PageIndexChanging">
                            <Columns >
                                ...
                                <asp:BoundField DataField="EntriesName" HeaderText="作品名称" />
                                ...
                                <asp:HyperLinkField DataNavigateUrlFields="EnrollID" DataNavigateUrlFormatString="UpFile.aspx?EnrollID={0}" HeaderText="上传作品" Text="上传" />
